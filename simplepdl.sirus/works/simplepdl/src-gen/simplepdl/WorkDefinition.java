...
public interface WorkDefinition extends ProcessElement {
	 ...
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_LinksToSuccessor()
	 ...
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_LinksToPredecessor()
	 ...
	 * The list contents are of type {@link simplepdl.Human}.
	 * It is bidirectional and its opposite is '{@link simplepdl.Human#getAsignedTasks <em>Asigned Tasks</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Assigned To</em>' reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_AssignedTo()
