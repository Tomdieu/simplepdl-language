...
public class WorkDefinitionItemProvider extends ProcessElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addRequiredmaterialPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Requiredmaterial feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRequiredmaterialPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WorkDefinition_requiredmaterial_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_WorkDefinition_requiredmaterial_feature",
								"_UI_WorkDefinition_type"),
						SimplepdlPackage.Literals.WORK_DEFINITION__REQUIREDMATERIAL, true, false, true, null, null,
						null));
	}
