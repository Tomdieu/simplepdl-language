...
/**
 * This is the item provider adapter for a {@link simplepdl.metamodel.simplepdl.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Process_description_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Process_description_feature",
								"_UI_Process_type"),
						SimplepdlPackage.Literals.PROCESS__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((simplepdl.metamodel.simplepdl.Process) object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(simplepdl.metamodel.simplepdl.Process.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SimplepdlPackage.Literals.PROCESS__RESOURCES,
				SimplepdlFactory.eINSTANCE.createHuman()));
