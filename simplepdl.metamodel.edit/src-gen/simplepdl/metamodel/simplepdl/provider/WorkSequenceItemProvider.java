...
/**
 * This is the item provider adapter for a {@link simplepdl.metamodel.simplepdl.WorkSequence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addLinkTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WorkSequence_linkType_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_WorkSequence_linkType_feature",
								"_UI_WorkSequence_type"),
						SimplepdlPackage.Literals.WORK_SEQUENCE__LINK_TYPE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_WorkSequence_predecessor_feature",
								"_UI_WorkSequence_type"),
						SimplepdlPackage.Literals.WORK_SEQUENCE__PREDECESSOR, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_WorkSequence_successor_feature",
								"_UI_WorkSequence_type"),
						SimplepdlPackage.Literals.WORK_SEQUENCE__SUCCESSOR, true, false, true, null, null, null));
	}
