...
public class SimplepdlActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction showPropertiesViewAction = new Action(
			SimplepdlEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			SimplepdlEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				...
				"simplepdl.metamodel.simplepdlMenuID");
		...
		createSiblingMenuManager = new MenuManager(
				SimplepdlEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
