 ...
 * </p>
 * <ul>
 *   <li>{@link simplepdl.metamodel.simplepdl.impl.WorkSequenceImpl#getLinkType <em>Link Type</em>}</li>
 *   <li>{@link simplepdl.metamodel.simplepdl.impl.WorkSequenceImpl#getPredecessor <em>Predecessor</em>}</li>
 *   <li>{@link simplepdl.metamodel.simplepdl.impl.WorkSequenceImpl#getSuccessor <em>Successor</em>}</li>
 * </ul>
 *
 * @generated
 */
		...
		if (newPredecessor != predecessor) {
			...
			if (predecessor != null)
				msgs = ((InternalEObject) predecessor).eInverseRemove(this,
						SimplepdlPackage.WORK_DEFINITION__LINKS_TO_SUCCESSOR, WorkDefinition.class, msgs);
		...
		if (newSuccessor != successor) {
			...
			if (successor != null)
				msgs = ((InternalEObject) successor).eInverseRemove(this,
						SimplepdlPackage.WORK_DEFINITION__LINKS_TO_PREDECESSOR, WorkDefinition.class, msgs);
