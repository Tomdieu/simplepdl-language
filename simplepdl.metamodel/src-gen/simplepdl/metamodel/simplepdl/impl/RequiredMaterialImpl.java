...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Required Material</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link simplepdl.metamodel.simplepdl.impl.RequiredMaterialImpl#getMaterial <em>Material</em>}</li>
 *   <li>{@link simplepdl.metamodel.simplepdl.impl.RequiredMaterialImpl#getQuantity <em>Quantity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequiredMaterialImpl extends MinimalEObjectImpl.Container implements RequiredMaterial {
	 ...
	 * @generated
	 */
	protected RequiredMaterialImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SimplepdlPackage.Literals.REQUIRED_MATERIAL;
	}
			...
			if (material != oldMaterial) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SimplepdlPackage.REQUIRED_MATERIAL__MATERIAL, oldMaterial, material));
			}
		}
		return material;
	}
	...
	public void setMaterial(Material newMaterial) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplepdlPackage.REQUIRED_MATERIAL__MATERIAL,
	...
	public void setQuantity(int newQuantity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplepdlPackage.REQUIRED_MATERIAL__QUANTITY,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SimplepdlPackage.REQUIRED_MATERIAL__MATERIAL:
			if (resolve)
				return getMaterial();
