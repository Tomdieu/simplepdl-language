...
public class SimplepdlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SimplepdlPackage.PROCESS: {
			simplepdl.metamodel.simplepdl.Process process = (simplepdl.metamodel.simplepdl.Process) theEObject;
	 ...
	 * @generated
	 */
	public T caseProcess(simplepdl.metamodel.simplepdl.Process object) {
		return null;
	}
